...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    Mission_Text: Schema.Attribute.Blocks;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Vision_Text: Schema.Attribute.Blocks;
...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    check_out: Schema.Attribute.Date;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Map_Embed: Schema.Attribute.String;
    Phone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    Section_Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiGalleryGallery extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Category: Schema.Attribute.Enumeration<
      ['Exterior', 'Interior', 'Rooms', 'Pool', 'Spa', 'Event', 'Other']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHotelDetailHotelDetail extends Struct.SingleTypeSchema {
  collectionName: 'hotel_details';
  info: {
    displayName: 'Hotel Detail';
    pluralName: 'hotel-details';
    singularName: 'hotel-detail';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::hotel-detail.hotel-detail'
    > &
      Schema.Attribute.Private;
    logo: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    main_photo: Schema.Attribute.Media<'images' | 'videos', true>;
    name: Schema.Attribute.String;
    phone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dateOfStay: Schema.Attribute.Date;
